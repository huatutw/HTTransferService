...
public:
	...
	static void  SendStringData(CIPCSocket& s,LPTSTR strContent,int nSize);
	
	static void  SendStringData(CIPCSocket& s,LPCWSTR strContent);
	static void  SendStringData(CIPCSocket& s,LPCSTR strContent);
	...
	static void  SendData(CIPCSocket& s,LPVOID lpData,int nSize);
