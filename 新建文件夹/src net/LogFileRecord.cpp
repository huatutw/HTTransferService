...
{
	_stprintf(strSQL,_T("INSERT INTO Log_File (file_ip,file_computer,file_time,file_user,file_doc,file_oper,file_internal_error,file_system_error,file_deleted,manage_guid, file_serverpath) SELECT '%s','%s','%s','%s','%s','%d','%d','%d',%d, '%s', '%s'"),
		m_strIP,m_strComputer,m_strTime,m_strUser,m_strFileName,m_nOperType,m_nInternalError,m_nSystemError,m_nDeleted,m_strGUID, m_strServerFilePath);
